  ...
  return (
    <div name="hero" className="w-full h-screen bg-[#0a192f]">
        ...
        <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
            ...
            <p className="text-[#8892b0] py-4 max-w-[700px]">I'm a full-stack developer specializing in building awesome digital experiences. Currently, I'm focused on building responsive full-stack web apps.</p>
            <div>
